...
// these are indices into the oks[] array
// L1-L6
#define PS_OKS_MASK_CLOCK 0x001U
#define PS_OKS_MASK_KU 0x01EU 
#define PS_OKS_MASK_ZU 0x1E0U
#define PS_OKS_MASK_VU 0x000U
#define PS_OKS_MASK_FF 0x200U

#define PS_OKS_DEMO_MASK  PS_OKS_MASK_CLOCK | PS_OKS_MASK_KU | PS_OKS_MASK_ZU | PS_OKS_MASK_FF
#define PS_OKS_PROTO_MASK PS_OKS_MASK_CLOCK | PS_OKS_MASK_VU | PS_OKS_MASK_FF
#elif defined(DEMO)
